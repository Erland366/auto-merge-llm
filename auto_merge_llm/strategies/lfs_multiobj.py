...
class LfsMoMerge(MergeStrategy):
    def __init__(self, config):
        ...
        self.evaluator_class = evaluator_classes['inmemory_evaluate'] if self.in_memory_evaluate else evaluator_classes['ondisk_evaluate']
    ...
    def optimize(self):
        ...
        if self.load_run_history != None:
            ...
            smac = HyperparameterOptimizationFacade(
                scenario,
                self.objective,  # pass the target function here
                overwrite=False, 
                intensifier=intensifier,
                initial_design=initial_design,
                multi_objective_algorithm=multi_objective_algorithm,
